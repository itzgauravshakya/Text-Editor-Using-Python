...
class TextEditor:
  ...
  def __init__(self,root):
    ...
    # Window Geometry
    self.root.geometry("1200x500+200+150")
    ...
    # Creating Titlebar
    self.titlebar = Label(self.root,textvariable=self.title,font=("times new roman",20,"bold"),bd=2,relief=GROOVE)
    ...
    # Creating Text Area
    self.txtarea = Text(self.root,yscrollcommand=scrol_y.set,font=("callibri",14,"bold"),state="normal",relief=GROOVE)
